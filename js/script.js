const coffeeTypes = {
	a: {
		...
		timesChosen: 0,
		image: 'url(https://github.com/erinannette/ErinMaaskant-Project3/assets/02-instant.svg)'
	},
	b: {
		name: 'Brewed',
		...
		timesChosen: 0,
		image: 'url(https://github.com/erinannette/ErinMaaskant-Project3/assets/03-brew.svg)'
	},
	c: {
		name: 'Cappuccino',
		...
		timesChosen: 0,
		image: 'url(https://github.com/erinannette/ErinMaaskant-Project3/assets/04-cappuccino.svg)'
	},
	d: {
		name: 'Ristretto',
		...
		timesChosen: 0,
		image: 'url(https://github.com/erinannette/ErinMaaskant-Project3/assets/05-ristretto.svg)'
	},
	e: {
		name: 'Unicorn Frappuccino',
		description: `Who are you, coffee imposter? You’re not coffee I don’t even know you.`,
		timesChosen: 0,
		image: 'url(https://github.com/erinannette/ErinMaaskant-Project3/assets/06-frappuccino.svg)'
	},
}
...
// GETTING THE ANSWER TO DISPLAY ONCE SUBMIT BUTTON IS CLICKED
	...
	$('form').on('submit', function (event) {
		...
		if (results.length > 1) {
			...
			$('#submit').css('background-image', `${finalResults[0].image}`);
